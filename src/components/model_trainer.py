...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            # Prections and evaluation metrics
            ...
            metric_artifact=ClassificationMetricArtifact(f1_score=f1,recall_score=recall,precision_score=precision,accuracy=accuracy)
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        ...
        try:
            ...
            trained_model, metric_artifact = self.get_model_object_and_report(train=train_array, test=test_array)
